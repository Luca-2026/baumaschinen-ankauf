...
In wenigen Schritten zum Ankaufspreis
          ...
          <div className="flex flex-col gap-4">
            ...
            <div className="grid gap-4 sm:grid-cols-2">
              <Link to="/ankauf?kategorie=bagger" className="group relative flex flex-col items-center gap-4 rounded-2xl border-2 border-border bg-card p-8 shadow-sm transition-all duration-300 hover:border-primary hover:shadow-xl hover:-translate-y-1 animate-fade-in" style={{
              ...
              <Link to="/ankauf?kategorie=arbeitsbuehne" className="group relative flex flex-col items-center gap-4 rounded-2xl border-2 border-border bg-card p-8 shadow-sm transition-all duration-300 hover:border-primary hover:shadow-xl hover:-translate-y-1 animate-fade-in" style={{
